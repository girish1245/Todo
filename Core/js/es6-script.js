...
function addTask() {
    ...
    if (document.getElementById('effect') !== null) {   //for Second element
        ...
        let span = document.createTextNode(task);
...
function selected(event) {
    ...
    // }
    else if(event.srcElement.localName === 'span' &&  (event.offsetX < 450)) {    // To uncheck completed tasks
